...
echo "names for private bosh subnet"
echo "subnetBoshName=$subnetBoshName"
echo "sgBoshName=$sgBoshName"
echo "cidrBosh=$cidrBosh"
echo "boshGWIP=$boshGWIP"
echo "directorIP=$directorIP"
echo "directorPassword=$directorPassword"

# names for public dmz subnet
subnetDMZName="$vpcName-public-dmz"
sgDMZName="$vpcName-public-dmz"
cidrDMZ="10.0.1.0/24"
echo "subnetDMZName=$subnetDMZName"
echo "sgDMZName=$sgDMZName"
echo "cidrDMZ=$cidrDMZ"

# elastic IP for jumpbox access
jumpboxElasticIpName=$subnetDMZName
echo "jumpboxElasticIpName=$jumpboxElasticIpName"
# elastic IP for NAT gateway access
natElasticIpName="$vpcName-nat"
echo "natElasticIpName=$natElasticIpName"

# name of internet gateway and NAT gateway
igwName=$vpcName
natgwName=$subnetDMZName
echo "igwName=$natgwName"
echo "natgwName=$keypairName"
